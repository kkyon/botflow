...
request_headers="""
POST /jobs/positionAjax.json?px=default&city=%E5%8C%97%E4%BA%AC&needAddtionalResult=false HTTP/1.1
Host: www.lagou.com
...
p=Pipe(
    ...
    Delay(3),
    lambda c_pn:HttpRequest(
            request_headers=request_headers,
            url = f"https://www.lagou.com/jobs/positionAjax.json?px=default&city={c_pn[0]}&needAddtionalResult=false",
            payload = f"first=false&pn={c_pn[1]}&kd=python",
